	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <!-- Mega Menu -->
					<li class="active"><a href="cinemas.php"  class="dropdown-toggle">电影</a></li>
...
<!-- AddThis Smart Layers END -->
	...
	<?php
		...
		$NAME_MOVIE_PAGE = "";		$Short_syno_MOVIE_PAGE = "";	$img_MOVIE_PAGE = "" ;
			...
			$sql = "SELECT a.Movie_No,a.Name,a.Short_synopsis FROM Movie a ";
			$result = $conn->query($sql);
			$num_movie_page = $result->num_rows;
			
			function MoviePage ()
			{
				$row = $GLOBALS['result']->fetch_assoc();
				$GLOBALS['NAME_MOVIE_PAGE'] =  $row["Name"];
				$GLOBALS['Short_syno_MOVIE_PAGE'] =  $row["Short_synopsis"];
				$GLOBALS['img_MOVIE_PAGE'] =  $row["Movie_No"];
			}

		function outputLinfo()
		{
			if($GLOBALS['num_movie_page']%2 == 0)
				$Left = $GLOBALS['num_movie_page']/2;
			else
				$Left = ($GLOBALS['num_movie_page']/2) + 1;
			
			for($i = 0;$i < $Left;$i++){
				MoviePage();
				$a = $GLOBALS['NAME_MOVIE_PAGE'] ;
				$b = $GLOBALS['Short_syno_MOVIE_PAGE'];
				$c = $GLOBALS['img_MOVIE_PAGE'];
				
				$output =<<<EOT
				<div class="col-md-6 cinema-list-left">
					<div class="cinema-list-grid">
						<div class="cinema-list-grid-img">
							<img src="images/$c$c.jpg" alt="" />
						</div>
						
						<div class="cinema-list-grid-text">
							<a href="single.php?new=$c">$a</a>
							<p>$b</p>
						</div>
						<div class="clearfix"></div>
					</div>
...
EOT;
		...
		function outputRinfo()
		{
			for($i = 0;$i < $GLOBALS['num_movie_page']/2;$i++){
				MoviePage();
				$a = $GLOBALS['NAME_MOVIE_PAGE'] ;
				$b = $GLOBALS['Short_syno_MOVIE_PAGE'];
				$c = $GLOBALS['img_MOVIE_PAGE'];
