...
<body>
	<!-- header-section-starts -->
		...
		$num = $result->num_rows;
		echo $num;?></a> | <a class="play-icon popup-with-zoom-anim" href="#small-dialog" href="#"> 信息管理</a> </p>
				<div id="small-dialog" class="mfp-hide">
						<div class="select-city">
							<h3>管理人员登陆</h3>
							<div class="confirmation">
							<form>
								<input type="text" class="email" placeholder="账号" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?" title="Enter a valid email"/>
								<input type="text" class="email" placeholder="密码" maxlength="10" pattern="[1-9]{1}\d{9}" title="Enter a valid mobile number" />
 ...
 if(log == 1){
	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="dropdown w3_megamenu-fw"><a href="index.php">主页</a></li>	
                    <!-- Mega Menu -->
					<li class="dropdown w3_megamenu-fw"><a href="cinemas.php"  class="dropdown-toggle">电影</a>	</li>
                        
					<li class="dropdown w3_megamenu-fw"><a href="trailers-now-showing.php"  class="dropdown-toggle">购票</a></li>
					<li class="active"><a href="blog.php" class="dropdown-toggle">评论</a></li>
	...
	<div class="blog-section">
		<div class="col-md-12 blog-posts">
			<h3 class="post">最近的评论</h3>
			
			<?php

		$NAME_COMMENT_PAGE1 = "";		$TEXT_COMMENT_PAGE1 = "";	
		$NUM_COMMENT_PAGE1 = "" ;		$IMG_COMMENT_PAGE1 = "";
		$NAME_COMMENT_PAGE2 = "";		$TEXT_COMMENT_PAGE2 = "";	
		$NUM_COMMENT_PAGE2 = "" ;		$IMG_COMMENT_PAGE2 = "";
		$NAME_COMMENT_PAGE3 = "";		$TEXT_COMMENT_PAGE3 = "";	
		$NUM_COMMENT_PAGE3 = "" ;		$IMG_COMMENT_PAGE3 = "";
		...
		$sql = "SELECT a.Movie_No,a.Name,a.Comment_of_people,b.Comments FROM Movie a,Comments b WHERE a.Name = b.Movie_Name Order By Comment_ID DESC ";
		$result = $conn->query($sql);
		$num_comment_page = $result->num_rows;
			
		function CommentPage ()
		{
			$row = $GLOBALS['result']->fetch_assoc();
			$GLOBALS['NAME_COMMENT_PAGE1'] =  $row["Name"];
			$GLOBALS['TEXT_COMMENT_PAGE1'] =  $row["Comments"];
			$GLOBALS['NUM_COMMENT_PAGE1'] =  $row["Comment_of_people"];
			$GLOBALS['IMG_COMMENT_PAGE1'] = $row["Movie_No"];
			
			$row = $GLOBALS['result']->fetch_assoc();
			$GLOBALS['NAME_COMMENT_PAGE2'] =  $row["Name"];
			$GLOBALS['TEXT_COMMENT_PAGE2'] =  $row["Comments"];
			$GLOBALS['NUM_COMMENT_PAGE2'] =  $row["Comment_of_people"];
			$GLOBALS['IMG_COMMENT_PAGE2'] = $row["Movie_No"];
			
			$row = $GLOBALS['result']->fetch_assoc();
			$GLOBALS['NAME_COMMENT_PAGE3'] =  $row["Name"];
			$GLOBALS['TEXT_COMMENT_PAGE3'] =  $row["Comments"];
			$GLOBALS['NUM_COMMENT_PAGE3'] =  $row["Comment_of_people"];
			$GLOBALS['IMG_COMMENT_PAGE3'] = $row["Movie_No"];
		}

		function outputComminfo()
		{
			$cycle = $GLOBALS['num_comment_page']/3;
			$mark = $GLOBALS['num_comment_page']%3;
			for($i = 0;$i < $cycle; $i++){
				CommentPage();
				$a = $GLOBALS['NAME_COMMENT_PAGE1'] ;
				$b = $GLOBALS['TEXT_COMMENT_PAGE1'];
				$c = $GLOBALS['NUM_COMMENT_PAGE1'];
				$d = $GLOBALS['IMG_COMMENT_PAGE1'];
				
				$e = $GLOBALS['NAME_COMMENT_PAGE2'] ;
				$f = $GLOBALS['TEXT_COMMENT_PAGE2'];
				$g = $GLOBALS['NUM_COMMENT_PAGE2'];
				$h = $GLOBALS['IMG_COMMENT_PAGE2'];
				
				$j = $GLOBALS['NAME_COMMENT_PAGE3'] ;
				$k = $GLOBALS['TEXT_COMMENT_PAGE3'];
				$l = $GLOBALS['NUM_COMMENT_PAGE3'];
				$m = $GLOBALS['IMG_COMMENT_PAGE3'];
				
				if( $GLOBALS['num_comment_page']%3 == 1 AND $i*3+1 == $GLOBALS['num_comment_page']){
					$output =<<<EOT
				<div class="blog-top">
							  <div class="col-md-4 grid_3">
									<a href="single.php?new=$d"><img src="images/$d.jpg" class="img-responsive" alt=""></a>
									<div class="blog-poast-info">
										<ul>
											<li><i class="fa fa-comments"></i><a class="p-blog" href=""><span> </span>$c Comments </a></li>
										</ul>
									</div>
									<h3><a href="single.php?new=$d">$a</a></h3>
									<p>$b</p>
								</div>
EOT;
								echo $output;
				}
				else if( $GLOBALS['num_comment_page']%3 == 2 AND $i*3+2 == $GLOBALS['num_comment_page']){
				$output =<<<EOT
				<div class="blog-top">
							  <div class="col-md-4 grid_3">
									<a href="single.php?new=$d"><img src="images/$d.jpg" class="img-responsive" alt=""></a>
								...
								<div class="col-md-4 grid_3">
																	<a href="single.php?new=$h"><img src="images/$h.jpg" class="img-responsive" alt=""></a>
									<div class="blog-poast-info">
										<ul>
											<li><i class="fa fa-comments"></i><a class="p-blog" href=""><span> </span>$g Comments </a></li>
										</ul>
									</div>
									<h3><a href="single.php?new=$h">$e</a></h3>
									<p>$f</p>
...
EOT;
				...
				<div class="blog-top">
							  <div class="col-md-4 grid_3">
								...
								<div class="col-md-4 grid_3">
																	<a href="single.php?new=$m"><img src="images/$m.jpg" class="img-responsive" alt=""></a>
									<div class="blog-poast-info">
										<ul>
											<li><i class="fa fa-comments"></i><a class="p-blog" href=""><span> </span>$l Comments </a></li>
										</ul>
									</div>
									<h3><a href="single.php?new=$m">$j</a></h3>
									<p>$k</p>
