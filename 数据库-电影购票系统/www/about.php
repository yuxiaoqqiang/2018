<?php
  ...
  if(isset($u)){
	$GLOBALS['username'] = $u->Usr_Username;
	$GLOBALS['userid'] = $u->UsrId;
	$GLOBALS['userphone'] = $u->UsrPhone;
    if(isset($_SESSION['user'])){
	$u = unserialize($_SESSION['user']);
  ...
  function page1($tk){
	  ...
	  for($i = 0; $i < $j; $i = $i + 2){
		  ...
		  $sql= "select Movie_No from movie where name = '".$a1."';" ;
		  ...
		  <div class="col-sm-6 about-left">
									<div class="about-left-grids">
										<div class="col-md-4 about-left-img">
										...
										<div class="col-md-7 about-left-info">
											...
											<a href="#" style="position:right;float:left;font-size: 100%" > >>>详情</a>
											<a href="refund.php?ticketid=$a6" style="position:right;float:right;font-size: 100%" > >>>退票</a>
										</div>
		  ...
		  <div class="col-sm-6 about-left">
									<div class="about-left-grids">
										...
										<div class="col-md-7 about-left-info">
											...
											<p> $a4 厅 $a5 座</p>
											<p>购票时间：$a6</p>
											<a href="#" style="position:right;float:right;font-size: 100%" > >>>详情</a>
										</div>
										<div class="clearfix"> </div>
									</div>
								</div>
...
<!-- AddThis Smart Layers END -->
	...
	<div class="about-section">
		...
		<div class="tabs-box">
			<ul class="tabs-menu">
				<li><a href="#tab1"><span> </span>我的信息</a></li>
				<li><a href="#tab2"><span> </span>未观看的</a></li>
				<li><a href="#tab3"><span> </span>已购订单</a></li>
				<li><a href="#tab4"><span> </span>退票信息</a></li>
			</ul>
			<div class="clearfix"> </div>
			<div class="tab-grids">
				<div id="tab1" class="tab-grid">
					...
					<p>——————————————————————————————————</p>
					<p> 账号：<?php echo $GLOBALS['userid'];?> </p>
					<p> 电话：<?php echo $GLOBALS['userphone'];?> </p>
					<p> 未观看票数：<?php $num1 = getTicketByDate_usrid($GLOBALS['userid']); echo count($num1);?>张 </p>
					<p> 已购影票数：<?php $num2 =   getAllTicketByusrid($GLOBALS['userid']); echo count($num2);?>张</p>
					<p> 已退影票数：<?php $num3 =getRefundTicketByusrid($GLOBALS['userid']); echo count($num3);?>张</p>
					<div class="clearfix"> </div>
				</div>
